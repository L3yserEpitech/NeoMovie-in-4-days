...
export default function Films() {
    ...
    const MovieCategories = () => {
      ...
      const selectedMedia = (
        ...
        // Met à jour l'état avec le média sélectionné
      ...
      // Vérifie que movieTriByGenre existe et qu'il n'est pas nul
        ...
        <>
          ...
          }
          {
            Object.keys(movieTriByGenre).map((category) => {
              const moviesInCategory = movieTriByGenre[category];

              // Vérifier si la catégorie contient des films
